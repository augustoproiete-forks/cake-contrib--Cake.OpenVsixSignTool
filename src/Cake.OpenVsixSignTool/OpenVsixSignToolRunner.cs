...
{
    /// <summary>
    /// Base class for all OpenVsixSignTool related tools.
    /// </summary>
    /// <typeparam name="TSettings">The settings type.</typeparam>
    public class OpenVsixSignToolRunner<TSettings>: Tool<TSettings>
        where TSettings : AutoToolSettings, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenVsixSignToolRunner{TSettings}"/> class.
        /// </summary>
        /// <param name="fileSystem">The file system.</param>
        /// <param name="environment">The environment.</param>
        /// <param name="processRunner">The process runner.</param>
        /// <param name="tools">The tool locator.</param>
        public OpenVsixSignToolRunner(
        ...
        {
            return new[] { "OpenVsixSignTool.exe", "OpenVsixSignTool" };
        }
        ...
        {
            var path = OpenVsixSignToolResolver.GetOpenVsixSignToolPath(_fileSystem, _environment);
            return path != null
                ? new[] { path }
